...
const Creport = () => {
  // All state and effect hooks remain exactly the same
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const response = await axios.get('https://pms-backend-00j9.onrender.com/api/notifications/coordinator/', {
          headers: {
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-600/80 mt-1">View and manage all submitted notifications</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {isLoading ? (
          <div className="text-center py-16">
            ...
            <p className="text-blue-700">Loading notifications...</p>
          </div>
        ) : reports.length > 0 ? (
          <div className="grid gap-6">
            {reports.map((report) => (
              <div
                key={report.id}
                className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-100 overflow-hidden group"
              >
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="text-blue-800/80 text-sm mb-4 line-clamp-2">
                        {report.description}
                      </div>
                    </div>
                  </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-blue-800 mb-2">No Notifications Available</h3>
            <p className="text-blue-600/80">Notifications will appear here once they are submitted.</p>
          </div>
        )}
      </div>
      ...
      {isModalOpen && selectedReport && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-blue-100 bg-gradient-to-r from-blue-500 to-blue-600">
            ...
            <div className="p-6">
              <div className="flex items-center gap-6 mb-6 pb-4 border-b border-blue-100">
              ...
              <div className="max-h-96 overflow-y-auto">
                <div className="max-w-none text-blue-900 text-sm leading-relaxed space-y-3">
            ...
            <div className="px-6 py-4 bg-blue-50 border-t border-blue-100">
              <button
                onClick={closeModal}
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-4 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 font-medium"
              >
                Close Notification
              </button>
            </div>
