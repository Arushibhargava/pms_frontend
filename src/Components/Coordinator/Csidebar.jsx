...
import { Users, Award, Bell, FileText, LogOut } from 'lucide-react';
...
const Csidebar = () => {
  ...
  const menuItems = [
    { id: 'groups', label: 'Group', path: '/coordinator', icon: Users },
    { id: 'marks', label: 'Marks', path: '/coordinator/marks', icon: Award },
    { id: 'notification', label: 'Notification', path: '/coordinator/notification', icon: Bell },
    { id: 'report', label: 'Report', path: '/coordinator/report', icon: FileText },
     { id: 'cproposals', label: 'Proposals', path: '/coordinator/cproposals', icon: FileText },
  ];

  return (
    <aside className="w-84 min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-blue-800 text-white flex flex-col justify-between shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
          ...
          <div className="relative group">
            <div  onClick={() => navigate('/coord-profile')}  className="w-36 h-36 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-full overflow-hidden mb-6 shadow-2xl shadow-blue-500/40 border-4 border-blue-300/30 group-hover:border-blue-300/50 transition-all duration-500 group-hover:shadow-blue-400/60 group-hover:scale-105">
              <div className="w-full h-full bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 flex items-center justify-center relative overflow-hidden">
                <span className="text-5xl font-black text-white drop-shadow-2xl z-10">CP</span>
        ...
        {/* Navigation Links - Only styling changed, logic remains identical */}
        <nav>
        ...
        <div className="mt-10 bg-gradient-to-br from-blue-500/25 via-blue-600/20 to-blue-700/25 backdrop-blur-lg rounded-3xl p-6 border border-blue-400/30 shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-500 hover:scale-105">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-200/80 text-sm font-medium">2 groups active</p>
            </div>
          </div>
          <div className="w-full bg-blue-800/40 rounded-full h-3 overflow-hidden shadow-inset">
            <div className="bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 h-3 rounded-full w-2/3 relative overflow-hidden shadow-lg">
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-blue-200/70 text-sm font-medium">© 2024 Coordinator Panel</p>
