...
import { Users, CheckSquare, Bell, BarChart3, LogOut, ChevronRight } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { id: 'tasks', label: 'Tasks', icon: CheckSquare, path: '/team/tasks' },
    { id: 'notifications', label: 'Notifications', icon: Bell, path: '/team/notifications' },
    { id: 'reports', label: 'Reports', icon: BarChart3, path: '/team/reports' },
    { id: 'weeklyprogress', label: 'Weekly Progress', icon: BarChart3, path: '/team/weeklyprogress' }
  ];
    ...
    <aside className="w-84 min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-blue-800 text-white flex flex-col justify-between shadow-2xl relative overflow-hidden">
              ...
              return (
                <li key={item.id}>
                  <NavLink
                    to={item.path}
                    className={({ isActive }) =>
                      `group relative w-full flex items-center px-5 py-5 rounded-2xl transition-all duration-300 transform hover:scale-105 overflow-hidden ${
                        isActive
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-blue-200/70 text-sm font-medium">© 2024 Team Panel</p>
