...
const CoordinatorSignup = () => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white p-4">
      <div className="bg-white/10 backdrop-blur-lg text-white p-12 rounded-2xl shadow-xl w-full max-w-xl border border-white/20">
        
        {/* Header */}
        <div className="text-center mb-10">
          <div className="flex items-center justify-center w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl shadow-lg mx-auto mb-6">
          ...
          <h2 className="text-3xl font-light text-blue-200 mb-5">
            Registration Portal
          </h2>
